...
import { sendFinanceContactEmail, type IntakeField } from "../../lib/email";
...
export const POST: APIRoute = async ({ request, clientAddress }) => {
	...
	try {
		await sendFinanceContactEmail(fields);
	} catch (err) {
		console.error("Failed to send finance contact form email", err);
