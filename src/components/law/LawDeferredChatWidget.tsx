...
const LawChatWidget = lazy(() => import("./LawChatWidget"));

const TRIGGER_EVENTS: (keyof WindowEventMap)[] = ["scroll", "pointerdown", "touchstart"];

/**
 * Keeps the law chat widget's code out of the initial page bundle. It loads
 * LawChatWidget.tsx only once the browser goes idle, or as soon as the visitor
 * scrolls, clicks, or taps, whichever happens first.
 */
export default function LawDeferredChatWidget() {
